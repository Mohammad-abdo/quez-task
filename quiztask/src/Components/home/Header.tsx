...
const Headre = () => {
  ...
  // }, [setLanguage, i18n]);
    return (
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="static" sx={{color:"#000",boxShadow:"none"}} className={classes.nvabar}> 
          <Toolbar>
            <Typography
              variant="h6"
              noWrap
              component="div"
              sx={{ display: { xs: 'none', sm: 'block',fontSize:"30px",fontWeight:"bold" } }}
              className={classes.Typography}
            >
             Welcome To Oure School
            </Typography>
            ...
            <Search  className={classes.searchInput}>
              ...
              >
                ...
                {/* <AccountCircle /> */}
                <Tooltip title="Open settings" sx={{height:"35px"}}>
              <IconButton sx={{height:"35px"}}>
                <Avatar alt="Remy Sharp" src="/images/avatar/2.jpeg" />
              </IconButton>
            </Tooltip>
              </IconButton>
            </Box>
